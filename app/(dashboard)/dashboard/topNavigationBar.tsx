...
export default function TopNavigationBar() {
    return (
        <section className="sticky top-0 mb-4 w-full bg-[var(--background-bg)] z-50">
            <div className="container-fluid py-4 flex justify-end items-center ">
                <div className="flex gap-2 items-center py-2 px-4 bg-white rounded-sm shadow-xs relative group hover:cursor-pointer">
                    ...
                    <ChevronDown className="ml-2 w-4 h-4 text-gray-500 transition-transform group-hover:rotate-180" />

                    {/* Enhanced Dropdown Content */}
                    <div className="absolute top-full right-0 mt-2 w-100 bg-white rounded-md shadow-lg border border-gray-100 invisible opacity-0 group-hover:visible group-hover:opacity-100 transition-all duration-200 z-50">
