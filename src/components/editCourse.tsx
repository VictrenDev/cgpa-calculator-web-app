...
export default function EditCourseModal({ courseId, isOpen, onClose }: EditCourseProps) {
    ...
    return (
        <section
            onClick={onClose}
            className="w-full h-screen fixed top-0 left-0 z-50 bg-gray-300/30 flex justify-center items-center">
            <div
